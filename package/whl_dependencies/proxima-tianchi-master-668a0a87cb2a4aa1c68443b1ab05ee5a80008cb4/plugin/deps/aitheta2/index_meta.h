...
public:
    ...
    IndexMeta(const IndexMeta &rhs)
        : major_order_(rhs.major_order_), type_(rhs.type_),
          dimension_(rhs.dimension_), unit_size_(rhs.unit_size_),
          element_size_(rhs.element_size_), space_id_(rhs.space_id_),
          ...
          reformer_name_(rhs.reformer_name_), trainer_name_(rhs.trainer_name_),
          builder_name_(rhs.builder_name_), reducer_name_(rhs.reducer_name_),
          ...
          streamer_params_(rhs.streamer_params_), attributes_(rhs.attributes_)
    {
    }
...
public:
    ...
    IndexQueryMeta(IndexMeta::FeatureTypes ft, uint32_t unit, uint32_t dim)
        : type_(ft), dimension_(dim), unit_size_(unit),
